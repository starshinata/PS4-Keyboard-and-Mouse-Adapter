...
namespace Pizza.KeyboardAndMouseAdapter.Backend.GamepadProcessing
{
    ...
    public class GamepadProcessor
    {
        ...
        {
            bool EnableMouseInput = InstanceSettings.EnableMouseInput && RemotePlayProcessUtil.IsRemotePlayInForeground();
        ...
        {
            //TODO why would i want screen width, and not the application width ?
            ...
            if (!RemotePlayProcessUtil.IsRemotePlayInForeground())
            {
